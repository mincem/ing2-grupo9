...
\QA
  ...
  {El 90\% de las veces el pedido es entregado en tiempo y forma} % medida de la respuesta
...
\QA
  ...
  {Externa} % fuente
  {Un clientes hace un pedido de rating para un programa} % estímulo
  {Sistema} % artefacto
  {Normal} % entorno
...
\QA
  ...
  {Almacenar los resultados de SQPost para poder mejorarlo.} % texto del atributo
